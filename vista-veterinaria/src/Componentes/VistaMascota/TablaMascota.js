...
const TablaMascota = (props) => {
    const encabezados = ['IdMascota', 'Nombre', 'Tipo', 'Dueño', 'Cita', 'Medicamento', 'FechaIngreso', 'Razon', '', ''];
    return (
        <div className="contenido">
            <div className="estados">
                <button type="button" class="btn btn-dark" onClick={() => { props.onChangeEstado(2); }}>Acceder a las API'S</button>
            </div>
            <div className="tabla">
                <table class="table">
